      ...
      '/blog/': [
        {
          ...
          children: [
            ...
            '/blog/claude-code-engineering-workflow.md',
            '/blog/claude-code-multi-agent-strategy.md',
            '/blog/claude-code-large-repo-debug-refactor.md',
            '/blog/claude-code-security-governance.md',
